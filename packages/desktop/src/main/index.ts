...
import { CHANNEL, PERSONAL } from "./constants"
...
const main = Effect.gen(function* () {
  ...
  const appId = app.isPackaged ? (PERSONAL ? PERSONAL_ID : APP_IDS[CHANNEL]) : "ai.opencode.desktop.dev"
  ...
  app.setName(app.isPackaged ? (PERSONAL ? PERSONAL_NAME : APP_NAMES[CHANNEL]) : "OpenCode Dev")
