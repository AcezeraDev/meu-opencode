export const dict: Record<string, string> = {
  ...
  "ui.browserPane.closedHint": "Type an address above to open a site. The agent works in this same browser, so you can sign in here and hand over.",
  "ui.browserPane.connecting": "Waiting for the first picture",
  "ui.browserPane.pairTitle": "Pair the browser extension",
  "ui.browserPane.pairHint": "In the OpenCode Browser Bridge extension popup, enter port {{port}} and the token from your config (browser.extensionToken), then Save and connect.",
