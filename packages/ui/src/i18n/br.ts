export const dict = {
  ...
  "ui.browserPane.closedHint": "Digite um endereço acima para abrir um site. A IA usa este mesmo navegador, então você pode entrar na sua conta aqui e deixar com ela.",
  "ui.browserPane.connecting": "Esperando a primeira imagem",
  "ui.browserPane.pairTitle": "Pareie a extensão do navegador",
  "ui.browserPane.pairHint": "No popup da extensão OpenCode Browser Bridge, coloque a porta {{port}} e o token da sua config (browser.extensionToken), e clique em Salvar e conectar.",
