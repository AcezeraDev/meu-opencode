...
const icons = {
  ...
  globe: {
    viewBox: "0 0 16 16",
    body: `<path d="M8 13.9C11.2585 13.9 13.9 11.2585 13.9 8C13.9 4.74152 11.2585 2.1 8 2.1M8 13.9C4.74152 13.9 2.1 11.2585 2.1 8C2.1 4.74152 4.74152 2.1 8 2.1M8 13.9C9.4 12.4 10.25 10.3 10.25 8C10.25 5.7 9.4 3.6 8 2.1M8 13.9C6.6 12.4 5.75 10.3 5.75 8C5.75 5.7 6.6 3.6 8 2.1M2.4 6.1H13.6M2.4 9.9H13.6" stroke="currentColor" stroke-miterlimit="10" stroke-linecap="square"/>`,
  },
  "grid-plus": {
    viewBox: "0 0 16 16",
