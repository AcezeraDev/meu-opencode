...
export const dict = {
  ...
  "session.new.hint.send": "send",
  "session.new.hint.newline": "new line",
  "board.title": "Control board",
  "board.open": "Open control board",
  "board.back": "Back to home",
  "board.summary": "Projects: {{projects}} · Sessions: {{sessions}}",
  "board.filter.all": "All",
  "board.column.running": "Running",
  "board.column.waiting": "Waiting for you",
  "board.column.idle": "Finished",
  "board.column.empty": "Nothing here",
  "board.reason.permission": "Needs your permission",
  "board.reason.question": "Has a question for you",
  "board.progress": "{{done}} of {{total}} tasks",
  "agents.title": "Agents",
  "agents.open": "Open agents",
  "agents.back": "Back to home",
  "agents.subtitle": "Create focused AI teammates, review their instructions, and start them on demand.",
  "agents.catalog": "Agent catalog",
  "agents.create": "New agent",
  "agents.loading": "Loading agents…",
  "agents.empty": "No agents available yet.",
  "agents.section.yours": "Your agents",
  "agents.section.native": "Built-in agents",
  "agents.readonly": "Read only",
  "agents.description.empty": "No description provided.",
  "agents.model.default": "Default model",
  "agents.run": "Run",
  "agents.run.unavailable": "Subagent only",
  "agents.runtime.start": "Turn on",
  "agents.runtime.stop": "Turn off",
  "agents.runtime.changing": "Please wait…",
  "agents.runtime.started": "Agent turned on",
  "agents.runtime.stopped": "Agent turned off",
  "agents.runtime.openSession": "Open session",
  "agents.runtime.cycles": "{{count}} cycles",
  "agents.runtime.status.starting": "Starting",
  "agents.runtime.status.running": "Working",
  "agents.runtime.status.waiting": "Checking again",
  "agents.runtime.status.error": "Recovering after error",
  "agents.runtime.status.stopped": "Off",
  "agents.runtime.summary.title": "Continuous execution",
  "agents.runtime.summary.active": "{{count}} agents running",
  "agents.runtime.summary.inactive": "No agents running",
  "agents.runtime.summary.scope": "Runs while OpenCode is open",
  "agents.edit": "Edit",
  "agents.editor.editing": "Editing agent",
  "agents.editor.creating": "Creating agent",
  "agents.editor.new": "Untitled agent",
  "agents.generate.label": "Generate with AI",
  "agents.generate.placeholder": "Describe the agent you want…",
  "agents.generate.action": "Generate",
  "agents.generate.running": "Generating…",
  "agents.generate.hint": "The generated description and prompt stay editable until you save.",
  "agents.generate.error": "Could not generate the agent",
  "agents.field.name": "Name",
  "agents.field.name.invalid": "Use lowercase letters, numbers, and hyphens only.",
  "agents.field.description": "Description",
  "agents.field.model": "Model",
  "agents.field.temperature": "Temperature",
  "agents.field.color": "Color",
  "agents.field.mode": "Mode",
  "agents.field.prompt": "System prompt",
  "agents.field.permissions": "Permissions",
  "agents.mode.all": "All",
  "agents.mode.primary": "Primary",
  "agents.mode.subagent": "Subagent",
  "agents.save": "Save agent",
  "agents.saving": "Saving…",
  "agents.delete.title": "Delete agent",
  "agents.delete.confirm": "Delete {{name}} from your OpenCode configuration? This removes its file from disk.",
  "agents.delete.action": "Delete",
  "agents.toast.saved": "Agent saved",
  "agents.toast.deleted": "Agent deleted",
  "session.mode.label": "Session layout",
  "session.mode.conversation": "Conversation",
  "session.mode.trail": "Execution trail",
  "session.trail.title": "Execution",
  "session.trail.count": "{{count}} steps",
  "session.trail.empty": "No steps yet. The agent's tool calls show up here as it works.",
  "session.trail.input": "Input",
  "session.trail.output": "Output",
  "session.trail.status.pending": "Pending",
  "browser.history.summary": "{{steps}} browser steps · browser {{browser}} · AI thinking {{model}}",
  "browser.history.show": "Show steps",
  "browser.history.hide": "Hide steps",
  "session.resume.message": "The AI stopped in the middle of this task{{where}}.",
  "session.resume.where": " (last page: {{page}})",
  "session.resume.action": "Continue where it stopped",
  "session.resume.prompt": "Continue where you stopped.{{where}} Before acting, look at how the page is now (browser_snapshot), since something may have changed while you were stopped.",
  "session.resume.promptWhere": " The last page open in the browser was {{url}}.",
  "session.trail.status.running": "Running",
  "session.trail.status.completed": "Completed",
  "session.trail.status.error": "Error",
  "session.mode.cockpit": "Cockpit",
  "session.mode.split": "Split workspace",
  "session.mode.review": "Review focus",
  "session.rail.title": "Sessions",
  "session.rail.status.running": "Running",
  "session.rail.status.waiting": "Waiting for you",
  ...
  "dialog.provider.roteia.note": "Brazilian gateway to models from many labs, billed in reais",
  ...
  "context.meter.title": "Context window",
  "context.meter.usage": "{{used}} of {{limit}} tokens",
  "context.meter.free": "{{free}} free",
  "context.meter.unknownLimit": "{{used}} tokens · limit unknown",
  "context.meter.empty": "Usage shows up after the model's first reply.",
  "context.meta.noModel": "No model has replied yet",
  "context.meta.active": "last active {{time}}",
  "context.ledger.title": "Last turn",
  "context.ledger.input": "Input",
  "context.ledger.output": "Output",
  "context.ledger.reasoning": "Reasoning",
  "context.ledger.cacheRead": "Cache read",
  "context.ledger.cacheWrite": "Cache write",
  "context.ledger.total": "Total",
  "context.ledger.cost": "Session cost",
  "context.growth.title": "Context per turn",
  "context.growth.turns": "{{count}} turns",
  "context.growth.readout": "Turn {{turn}} · {{tokens}} tokens",
  "context.growth.ariaLabel": "Context grew from {{first}} to {{last}} tokens over {{count}} turns",
  "context.raw.count": "you {{user}} · assistant {{assistant}}",
  "context.raw.user": "You",
  "context.raw.assistant": "Assistant",
  "context.systemPrompt.expand": "Show all",
  "context.systemPrompt.collapse": "Show less",
  ...
  "titlebar.personalUpdate.restart": "Restart",
  "titlebar.personalUpdate.progress": "Building · {{step}} · {{minutes}} min",
  "titlebar.personalUpdate.step.waiting": "waiting for the current build",
  "titlebar.personalUpdate.step.icons": "icons",
  "titlebar.personalUpdate.step.metadata": "metadata",
  "titlebar.personalUpdate.step.server": "server",
  "titlebar.personalUpdate.step.interface": "interface",
  "titlebar.personalUpdate.step.installer": "installer",
  "titlebar.personalUpdate.tooltip": "Update to the newest version",
  "titlebar.personalUpdate.buildingTooltip": "Building a new version from your local code. This takes a few minutes.",
  "titlebar.personalUpdate.readyTooltip": "New version ready ({{version}}). Restart to install it.",
  "titlebar.personalUpdate.downloadingTooltip": "Downloading version {{version}} published on GitHub.",
  ...
  "settings.updates.action.building": "Building...",
  "scope.tool.read": "reading",
  "scope.tool.edit": "editing",
  "scope.tool.write": "writing",
  "scope.tool.patch": "patching",
  "scope.tool.shell": "running",
  "scope.tool.search": "searching",
  "scope.tool.fetch": "opening",
  "scope.tool.web": "searching the web for",
  "scope.tool.task": "delegating",
  "scope.tool.plan": "planning",
  "scope.tool.video": "generating video",
  "scope.step.waiting": "waiting for the model",
  "scope.step.thinking": "thinking",
  "scope.step.writing": "writing the answer",
  "scope.strip.time": "Time",
  "scope.strip.rate": "Rate",
  "scope.strip.step": "Step",
  "scope.strip.steps": "Steps",
  "scope.strip.cost": "Cost",
  "scope.strip.eta": "Left",
  "scope.eta.plan": "From the agent's plan: {{done}} of {{total}} tasks done, at the pace it is keeping.",
  "scope.eta.history": "From your history: requests with this model usually take {{typical}} ({{runs}} requests measured).",
  "scope.eta.unknown": "Not enough history yet to estimate.",
  "scope.eta.over": "It is already past the time requests like this usually take.",
  "scope.stats.ariaLabel": "Response summary",
  "scope.stats.duration": "Time",
  "scope.stats.tools": "Tools",
  "scope.stats.files": "Files",
  "scope.stats.output": "Output",
  "scope.stats.rate": "Rate",
  "scope.stats.cost": "Cost",
  "scope.overview.label": "Conversation overview",
  "scope.overview.edit": "File edit",
  "scope.overview.error": "Error",
  "scope.overview.live": "Agent working",
  "scope.context.label": "{{percent}}% of context used",
  "scope.context.usage": "{{used}} of {{limit}} tokens",
  "scope.context.hint": "Compacting summarizes the conversation so far to free up space.",
  "scope.context.compact": "Compact now",
  "scope.context.open": "Details",
  "scope.spend.today": "Today",
  "scope.spend.title": "Model spend today",
  "scope.spend.messages": "{{count}} responses",
  "scope.spend.responses": "Responses",
  "scope.spend.limit": "Daily limit (US$)",
  "scope.spend.limitHint": "0 turns the alert off.",
  "scope.spend.inDollars": "In dollars",
  "scope.spend.rate": "Rate: {{rate}} per US$ 1",
  "scope.spend.limitLocal": "≈ {{value}} a day",
  "scope.spend.over": "Daily limit reached",
  "scope.spend.overDescription": "You spent {{spent}} today, over your {{limit}} limit.",
  "softkeys.title": "Shortcuts",
  "softkeys.hint": "Release Ctrl to close",
  "softkeys.other": "Other",
  "settings.general.row.lite.title": "Lightweight mode",
  "settings.general.row.lite.description":
    "Turns off endless animations (RGB cycling, the trace around the chat, scans and pulses) so the app and the browser panel stay light.",
  "settings.general.row.chroma.title": "RGB color",
  "settings.general.row.chroma.description": "Highlights keep cycling through colors. Off keeps a single color.",
  "settings.general.row.chromaSpeed.title": "RGB speed",
  "settings.general.row.chromaSpeed.description": "How fast the highlights go around the color wheel",
  "settings.general.row.chromaSpeed.slow": "Slow",
  "settings.general.row.chromaSpeed.medium": "Medium",
  "settings.general.row.chromaSpeed.fast": "Fast",
  "settings.general.row.chromaGlow.title": "Glow while responding",
  "settings.general.row.chromaGlow.description": "An RGB trace runs around the chat while the agent works",
  "settings.general.row.dailyLimit.title": "Daily spend limit",
  "settings.general.row.dailyLimit.description": "In US$. The titlebar readout turns amber near it and red past it; 0 turns it off.",
  ...
  "settings.providers.roteia.connected.one": "Connected · {{count}} model",
  "settings.providers.roteia.connected.other": "Connected · {{count}} models",
  "settings.providers.roteia.checking": "Checking connection…",
  "settings.providers.roteia.unreachable": "Could not check the connection to Roteia.",
  "settings.providers.roteia.key.label": "API key:",
  "settings.providers.roteia.key.env": "ROTEIA_API_KEY environment variable",
  "settings.providers.roteia.key.config": "set in the configuration file",
  "settings.providers.roteia.test": "Test connection",
  "settings.providers.roteia.refresh": "Refresh models",
  "settings.providers.roteia.refreshing": "Refreshing…",
  "settings.providers.roteia.changeKey": "Change key",
  "settings.video.title": "Video",
  "settings.video.loadError": "Could not load video models from the server.",
  "settings.video.key.configured": "NanoGPT API key found on the server. The key never leaves the server.",
  "settings.video.key.missing":
    "No NanoGPT API key on the server. Set NANOGPT_API_KEY or connect the NanoGPT provider to generate videos.",
  "settings.video.section.generation": "Generation",
  "settings.video.section.style": "Style",
  "settings.video.section.advanced": "Advanced",
  "settings.video.controlledByModel": "Controlled by the model",
  "settings.video.auto": "Auto",
  "settings.video.auto.quality": "Auto (quality preset)",
  "settings.video.row.model": "Model",
  "settings.video.row.purpose": "Purpose",
  "settings.video.row.purpose.description": "Default use when the request does not say.",
  "settings.video.row.duration": "Duration",
  "settings.video.row.aspectRatio": "Aspect ratio",
  "settings.video.row.quality": "Quality",
  "settings.video.row.quality.description": "Picks among the resolutions and steps this model really offers.",
  "settings.video.row.resolution": "Resolution",
  "settings.video.row.fps": "FPS",
  "settings.video.row.motion": "Motion",
  "settings.video.row.camera": "Camera",
  "settings.video.row.scroll": "Scroll optimized",
  "settings.video.row.scroll.description": "Continuous, cut-free motion that is easy to scrub with scroll.",
  "settings.video.row.loop": "Loop friendly",
  "settings.video.row.loop.description": "Guides the ending to visually connect with the beginning.",
  "settings.video.row.audio": "Audio",
  "settings.video.row.audio.description": "Off by default for website backgrounds.",
  "settings.video.row.audio.unsupported": "This model has no audio control.",
  "settings.video.row.cost": "Estimated cost",
  "settings.video.row.cost.description": "From the pricing NanoGPT publishes for these settings.",
  "settings.video.cost.unavailable": "Unavailable",
  "settings.video.row.preset": "Video style",
  "settings.video.preset.none": "None",
  "settings.video.preset.none.description": "Videos follow only what you ask in the chat and the settings below.",
  "settings.video.preset.hero-3d": "3D product hero",
  "settings.video.preset.hero-3d.description":
    "Clean studio, a smooth 360° turn, one reveal moment (like a cap coming off) and a seamless loop. Works with any product photo.",
  "settings.video.preset.turntable": "360° turntable",
  "settings.video.preset.turntable.description":
    "Clean studio and a smooth, constant 360° turn that loops. Great for showing every side of a product.",
  "settings.video.preset.controlled": "Set by the style",
  "settings.video.row.requireImage": "Generate from a photo",
  "settings.video.row.requireImage.description":
    "Videos animate a photo you attach in the chat (image-to-video). Only models that accept images are listed.",
  "settings.video.aspect.fromPhoto": "Follows the photo",
  "settings.video.advanced.hint":
    'Options this model accepts per generation. Ask for them in chat, e.g. "use seed 42".',
  "settings.video.advanced.none": "This model has no advanced options.",
  "settings.video.advanced.free": "Any value",
  "settings.video.advanced.seed": "Seed",
  "settings.video.advanced.inferenceSteps": "Inference steps",
  "settings.video.advanced.numFrames": "Number of frames",
  "settings.video.advanced.negativePrompt": "Negative prompt",
  "settings.video.advanced.cameraFixed": "Camera fixed",
  "settings.video.advanced.cfg": "CFG scale",
  "settings.video.advanced.proMode": "Pro mode",
  "settings.video.saving": "Saving…",
  "settings.video.saved": "Saved",
  "settings.video.saveError": "Could not save the video settings.",
  "settings.video.purpose.hero": "Hero",
  "settings.video.purpose.background": "Background",
  "settings.video.purpose.scroll": "Scroll",
  "settings.video.purpose.product": "Product",
  "settings.video.purpose.abstract": "Abstract",
  "settings.video.purpose.section": "Section",
  "settings.video.quality.draft": "Draft",
  "settings.video.quality.standard": "Standard",
  "settings.video.quality.high": "High",
  "settings.video.motion.subtle": "Subtle",
  "settings.video.motion.medium": "Medium",
  "settings.video.motion.dynamic": "Dynamic",
  "settings.video.camera.static": "Static",
  "settings.video.camera.slow-pan": "Slow pan",
  "settings.video.camera.slow-zoom": "Slow zoom",
  "settings.video.camera.orbit": "Orbit",
  "settings.video.camera.dolly": "Dolly",
  "settings.video.camera.custom": "Custom (from prompt)",
