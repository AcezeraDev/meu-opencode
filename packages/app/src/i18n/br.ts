export const dict = {
  ...
  "agents.generate.hint": "A descrição e o prompt gerados continuam editáveis até você salvar.",
  ...
  "agents.field.prompt": "Prompt de sistema",
  ...
  "settings.video.purpose.hero": "Hero",
  "settings.video.purpose.background": "Background",
  "settings.video.purpose.scroll": "Scroll",
  ...
  "settings.video.camera.dolly": "Dolly",
  "settings.video.camera.custom": "Personalizada (pelo prompt)",
