export const dict = {
  ...
  "session.new.hint.send": "enviar",
  "session.new.hint.newline": "nova linha",
  "board.title": "Mesa de controle",
  "board.open": "Abrir mesa de controle",
  "board.back": "Voltar ao início",
  "board.summary": "Projetos: {{projects}} · Sessões: {{sessions}}",
  "board.filter.all": "Todos",
  "board.column.running": "Executando",
  "board.column.waiting": "Aguardando você",
  "board.column.idle": "Concluídas",
  "board.column.empty": "Nada por aqui",
  "board.reason.permission": "Precisa da sua permissão",
  "board.reason.question": "Tem uma pergunta para você",
  "board.progress": "{{done}} de {{total}} tarefas",
  "agents.title": "Agentes",
  "agents.open": "Abrir agentes",
  "agents.back": "Voltar ao início",
  "agents.subtitle": "Crie assistentes de IA especializados, revise as instruções e inicie quando precisar.",
  "agents.catalog": "Catálogo de agentes",
  "agents.create": "Novo agente",
  "agents.loading": "Carregando agentes…",
  "agents.empty": "Nenhum agente disponível ainda.",
  "agents.section.yours": "Seus agentes",
  "agents.section.native": "Agentes integrados",
  "agents.readonly": "Somente leitura",
  "agents.description.empty": "Nenhuma descrição informada.",
  "agents.model.default": "Modelo padrão",
  "agents.run": "Rodar",
  "agents.run.unavailable": "Só subagente",
  "agents.runtime.start": "Ligar",
  "agents.runtime.stop": "Desligar",
  "agents.runtime.changing": "Aguarde…",
  "agents.runtime.started": "Agente ligado",
  "agents.runtime.stopped": "Agente desligado",
  "agents.runtime.openSession": "Abrir sessão",
  "agents.runtime.cycles": "{{count}} ciclos",
  "agents.runtime.status.starting": "Iniciando",
  "agents.runtime.status.running": "Trabalhando",
  "agents.runtime.status.waiting": "Verificando novamente",
  "agents.runtime.status.error": "Reconectando após erro",
  "agents.runtime.status.stopped": "Desligado",
  "agents.runtime.summary.title": "Execução contínua",
  "agents.runtime.summary.active": "{{count}} agentes ligados",
  "agents.runtime.summary.inactive": "Nenhum agente ligado",
  "agents.runtime.summary.scope": "Funciona enquanto o OpenCode estiver aberto",
  "agents.edit": "Editar",
  "agents.editor.editing": "Editando agente",
  "agents.editor.creating": "Criando agente",
  "agents.editor.new": "Agente sem título",
  "agents.generate.label": "Gerar com IA",
  "agents.generate.placeholder": "Descreva o agente que você quer…",
  "agents.generate.action": "Gerar",
  "agents.generate.running": "Gerando…",
  "agents.generate.hint": "A descrição e as instruções geradas continuam editáveis até você salvar.",
  "agents.generate.error": "Não foi possível gerar o agente",
  "agents.field.name": "Nome",
  "agents.field.name.invalid": "Use apenas letras minúsculas, números e hífens.",
  "agents.field.description": "Descrição",
  "agents.field.model": "Modelo",
  "agents.field.temperature": "Temperatura",
  "agents.field.color": "Cor",
  "agents.field.mode": "Modo",
  "agents.field.prompt": "Instruções do sistema",
  "agents.field.permissions": "Permissões",
  "agents.mode.all": "Todos",
  "agents.mode.primary": "Principal",
  "agents.mode.subagent": "Subagente",
  "agents.save": "Salvar agente",
  "agents.saving": "Salvando…",
  "agents.delete.title": "Apagar agente",
  "agents.delete.confirm": "Apagar {{name}} da configuração do OpenCode? Isso remove o arquivo do disco.",
  "agents.delete.action": "Apagar",
  "agents.toast.saved": "Agente salvo",
  "agents.toast.deleted": "Agente apagado",
  "session.mode.label": "Layout da sessão",
  "session.mode.conversation": "Conversa",
  "session.mode.trail": "Execução em trilho",
  "session.trail.title": "Execução",
  "session.trail.count": "{{count}} etapas",
  "session.trail.empty": "Nenhuma etapa ainda. As ações do agente aparecem aqui enquanto ele trabalha.",
  "session.trail.input": "Entrada",
  "session.trail.output": "Saída",
  "session.trail.status.pending": "Aguardando",
  "browser.history.summary": "{{steps}} passos no navegador · navegador {{browser}} · IA pensando {{model}}",
  "browser.history.show": "Ver passos",
  "browser.history.hide": "Ocultar passos",
  "session.resume.message": "A IA parou no meio desta tarefa{{where}}.",
  "session.resume.where": " (última página: {{page}})",
  "session.resume.action": "Continuar de onde parou",
  "session.resume.prompt": "Continue de onde você parou.{{where}} Antes de agir, veja como a página está agora (browser_snapshot), porque algo pode ter mudado enquanto você estava parado.",
  "session.resume.promptWhere": " A última página aberta no navegador era {{url}}.",
  "session.trail.status.running": "Executando",
  "session.trail.status.completed": "Concluída",
  "session.trail.status.error": "Erro",
  "session.mode.cockpit": "Cabine",
  "session.mode.split": "Espaço dividido",
  "session.mode.review": "Revisão em foco",
  "session.rail.title": "Sessões",
  "session.rail.status.running": "Executando",
  "session.rail.status.waiting": "Aguardando você",
  ...
  "command.prompt.mode.normal": "Mensagem",
  ...
  "dialog.provider.roteia.note": "Gateway brasileiro com modelos de vários laboratórios, cobrado em reais",
  ...
  "prompt.placeholder.shell": "Digite um comando do terminal... {{example}}",
  ...
  "prompt.mode.normal": "Mensagem",
  "prompt.mode.shell.exit": "esc para sair",
  "session.child.promptDisabled": "Não é possível enviar mensagens em sessões de subagentes.",
  ...
  "prompt.menu.shellCommand": "Comando do terminal",
  ...
  "prompt.toast.modelAgentRequired.description": "Escolha um agente e um modelo antes de enviar uma mensagem.",
  "prompt.toast.worktreeCreateFailed.title": "Falha ao criar a cópia de trabalho",
  "prompt.toast.sessionCreateFailed.title": "Falha ao criar sessão",
  "prompt.toast.shellSendFailed.title": "Falha ao enviar o comando do terminal",
  "prompt.toast.commandSendFailed.title": "Falha ao enviar comando",
  "prompt.toast.promptSendFailed.title": "Falha ao enviar a mensagem",
  ...
  "dialog.plugins.empty": "Complementos configurados em opencode.json",
  ...
  "context.systemPrompt.title": "Instruções do sistema",
  ...
  "context.meter.title": "Janela de contexto",
  "context.meter.usage": "{{used}} de {{limit}} tokens",
  "context.meter.free": "{{free}} livres",
  "context.meter.unknownLimit": "{{used}} tokens · limite desconhecido",
  "context.meter.empty": "O uso aparece depois da primeira resposta do modelo.",
  "context.meta.noModel": "Nenhum modelo respondeu ainda",
  "context.meta.active": "última atividade {{time}}",
  "context.ledger.title": "Último turno",
  "context.ledger.input": "Entrada",
  "context.ledger.output": "Saída",
  "context.ledger.reasoning": "Raciocínio",
  "context.ledger.cacheRead": "Cache lido",
  "context.ledger.cacheWrite": "Cache gravado",
  "context.ledger.total": "Total",
  "context.ledger.cost": "Custo da sessão",
  "context.growth.title": "Contexto por turno",
  "context.growth.turns": "{{count}} turnos",
  "context.growth.readout": "Turno {{turn}} · {{tokens}} tokens",
  "context.growth.ariaLabel": "O contexto foi de {{first}} a {{last}} tokens em {{count}} turnos",
  "context.raw.count": "você {{user}} · assistente {{assistant}}",
  "context.raw.user": "Você",
  "context.raw.assistant": "Assistente",
  "context.systemPrompt.expand": "Mostrar tudo",
  "context.systemPrompt.collapse": "Mostrar menos",
  "context.usage.tokens": "Tokens (pedaços de texto)",
  ...
  "toast.workspace.disabled.description": "Apenas a pasta principal é exibida na barra lateral",
  ...
  "error.chain.status": "Código: {{status}}",
  ...
  "session.review.noUncommittedChanges": "Ainda não há alterações não salvas no git",
  "session.review.noBranchChanges": "Ainda não há alterações neste ramo",
  ...
  "session.new.worktree.create": "Criar nova cópia de trabalho",
  ...
  "prompt.loading": "Carregando mensagem...",
  ...
  "terminal.connectTicket.statusError": "O tíquete de conexão do terminal falhou com o código {{status}}",

  "titlebar.update": "Atualizar",
  "titlebar.updateVersion": "Atualizar {{version}}",
  "titlebar.personalUpdate.restart": "Reiniciar",
  "titlebar.personalUpdate.progress": "Compilando · {{step}} · {{minutes}} min",
  "titlebar.personalUpdate.step.waiting": "esperando a compilação atual",
  "titlebar.personalUpdate.step.icons": "ícones",
  "titlebar.personalUpdate.step.metadata": "metadados",
  ...
  "settings.search.placeholder": "Buscar configuração",
  "settings.search.alsoIn": "Também em",
  "settings.search.empty": "Nenhuma opção de Geral tem “{{query}}”.",
  ...
  "settings.general.section.feed": "Atividade",
  ...
  "settings.general.row.shell.title": "Programa do terminal",
  ...
  "settings.general.row.shellToolPartsExpanded.title": "Expandir os comandos de terminal",
  ...
  "settings.updates.action.building": "Compilando...",
  "scope.tool.read": "lendo",
  "scope.tool.edit": "editando",
  "scope.tool.write": "criando",
  "scope.tool.patch": "aplicando patch em",
  "scope.tool.shell": "rodando",
  "scope.tool.search": "procurando",
  "scope.tool.fetch": "abrindo",
  "scope.tool.web": "pesquisando na web",
  "scope.tool.task": "delegando",
  "scope.tool.plan": "planejando",
  "scope.tool.video": "gerando vídeo",
  "scope.step.waiting": "aguardando o modelo",
  "scope.step.thinking": "pensando",
  "scope.step.writing": "escrevendo a resposta",
  "scope.strip.time": "Tempo",
  "scope.strip.rate": "Vel",
  "scope.strip.step": "Etapa",
  "scope.strip.steps": "Passos",
  "scope.strip.cost": "Custo",
  "scope.strip.eta": "Falta",
  "scope.eta.plan": "Pelo plano da IA: {{done}} de {{total}} tarefas feitas, no ritmo que ela está fazendo.",
  "scope.eta.history": "Pelo seu histórico: pedidos com este modelo costumam levar {{typical}} ({{runs}} pedidos medidos).",
  "scope.eta.unknown": "Ainda sem histórico suficiente para estimar.",
  "scope.eta.over": "Já passou do tempo que pedidos assim costumam levar.",
  "scope.stats.ariaLabel": "Resumo da resposta",
  "scope.stats.duration": "Duração",
  "scope.stats.tools": "Ferramentas",
  "scope.stats.files": "Arquivos",
  "scope.stats.output": "Saída",
  "scope.stats.rate": "Vel",
  "scope.stats.cost": "Custo",
  "scope.overview.label": "Visão geral da conversa",
  "scope.overview.edit": "Edição de arquivo",
  "scope.overview.error": "Erro",
  "scope.overview.live": "IA trabalhando",
  "scope.context.label": "{{percent}}% do contexto usado",
  "scope.context.usage": "{{used}} de {{limit}} tokens",
  "scope.context.hint": "Compactar resume a conversa até aqui para liberar espaço.",
  "scope.context.compact": "Compactar agora",
  "scope.context.open": "Detalhes",
  "scope.spend.today": "Hoje",
  "scope.spend.title": "Gasto com modelos hoje",
  "scope.spend.messages": "{{count}} respostas",
  "scope.spend.responses": "Respostas",
  "scope.spend.limit": "Limite diário (US$)",
  "scope.spend.limitHint": "0 desliga o alerta.",
  "scope.spend.inDollars": "Em dólar",
  "scope.spend.rate": "Cotação: {{rate}} por US$ 1",
  "scope.spend.limitLocal": "≈ {{value}} por dia",
  "scope.spend.over": "Limite diário atingido",
  "scope.spend.overDescription": "Você gastou {{spent}} hoje, acima do limite de {{limit}}.",
  "softkeys.title": "Atalhos",
  "softkeys.hint": "Solte o Ctrl para fechar",
  "softkeys.other": "Outros",
  "settings.general.row.lite.title": "Modo leve",
  "settings.general.row.lite.description":
    "Desliga as animações sem fim (RGB girando, rastro em volta do chat, varreduras e pulsos) para o app e o painel do navegador ficarem leves.",
  "settings.general.row.chroma.title": "Cor RGB",
  "settings.general.row.chroma.description": "Os destaques mudam de cor sem parar. Desligado, ficam numa cor só.",
  "settings.general.row.chromaSpeed.title": "Velocidade do RGB",
  "settings.general.row.chromaSpeed.description": "Quão rápido os destaques dão a volta nas cores",
  "settings.general.row.chromaSpeed.slow": "Lenta",
  "settings.general.row.chromaSpeed.medium": "Média",
  "settings.general.row.chromaSpeed.fast": "Rápida",
  "settings.general.row.chromaGlow.title": "Brilho enquanto a IA responde",
  "settings.general.row.chromaGlow.description": "Um traço RGB percorre a borda do chat enquanto a IA trabalha",
  "settings.general.row.dailyLimit.title": "Limite de gasto diário",
  "settings.general.row.dailyLimit.description": "Em US$. O valor na barra de título fica âmbar perto do limite e vermelho ao passar; 0 desliga.",
  ...
  "settings.shortcuts.group.prompt": "Mensagem",
  ...
  "settings.providers.roteia.connected.one": "Conectado · {{count}} modelo",
  "settings.providers.roteia.connected.many": "Conectado · {{count}} de modelos",
  "settings.providers.roteia.connected.other": "Conectado · {{count}} modelos",
  "settings.providers.roteia.checking": "Verificando a conexão…",
  "settings.providers.roteia.unreachable": "Não foi possível verificar a conexão com a Roteia.",
  "settings.providers.roteia.key.label": "Chave de API:",
  "settings.providers.roteia.key.env": "variável de ambiente ROTEIA_API_KEY",
  "settings.providers.roteia.key.config": "definida no arquivo de configuração",
  "settings.providers.roteia.test": "Testar conexão",
  "settings.providers.roteia.refresh": "Atualizar modelos",
  "settings.providers.roteia.refreshing": "Atualizando…",
  "settings.providers.roteia.changeKey": "Alterar chave",
  "settings.video.title": "Vídeo",
  "settings.video.loadError": "Não foi possível carregar os modelos de vídeo do servidor.",
  "settings.video.key.configured": "Chave da API NanoGPT encontrada no servidor. A chave nunca sai do servidor.",
  "settings.video.key.missing":
    "Nenhuma chave NanoGPT no servidor. Defina NANOGPT_API_KEY ou conecte o provedor NanoGPT para gerar vídeos.",
  "settings.video.section.generation": "Geração",
  "settings.video.section.style": "Estilo",
  "settings.video.section.advanced": "Avançado",
  "settings.video.controlledByModel": "Controlado pelo modelo",
  "settings.video.auto": "Automático",
  "settings.video.auto.quality": "Automático (preset de qualidade)",
  "settings.video.row.model": "Modelo",
  "settings.video.row.purpose": "Finalidade",
  "settings.video.row.purpose.description": "Uso padrão quando o pedido não especificar.",
  "settings.video.row.duration": "Duração",
  "settings.video.row.aspectRatio": "Proporção",
  "settings.video.row.quality": "Qualidade",
  "settings.video.row.quality.description": "Escolhe entre as resoluções e etapas que este modelo realmente oferece.",
  "settings.video.row.resolution": "Resolução",
  "settings.video.row.fps": "FPS",
  "settings.video.row.motion": "Movimento",
  "settings.video.row.camera": "Câmera",
  "settings.video.row.scroll": "Otimizado para scroll",
  "settings.video.row.scroll.description": "Movimento contínuo e sem cortes, fácil de controlar pelo scroll.",
  "settings.video.row.loop": "Pensado para loop",
  "settings.video.row.loop.description": "Orienta o final a se conectar visualmente com o começo.",
  "settings.video.row.audio": "Áudio",
  "settings.video.row.audio.description": "Desligado por padrão para fundos de sites.",
  "settings.video.row.audio.unsupported": "Este modelo não tem controle de áudio.",
  "settings.video.row.cost": "Custo estimado",
  "settings.video.row.cost.description":
    "Calculado pela tabela de preços publicada pela NanoGPT para estas configurações.",
  "settings.video.cost.unavailable": "Indisponível",
  "settings.video.row.preset": "Estilo do vídeo",
  "settings.video.preset.none": "Nenhum",
  "settings.video.preset.none.description": "Os vídeos seguem só o que você pedir no chat e as configurações abaixo.",
  "settings.video.preset.hero-3d": "Hero 3D de produto",
  "settings.video.preset.hero-3d.description":
    "Estúdio limpo, giro suave de 360°, um momento de revelação (como a tampa saindo) e loop perfeito. Funciona com foto de qualquer produto.",
  "settings.video.preset.turntable": "Vitrine 360°",
  "settings.video.preset.turntable.description":
    "Estúdio limpo e giro de 360° suave e constante, em loop. Ótimo para mostrar todos os lados do produto.",
  "settings.video.preset.controlled": "Definido pelo estilo",
  "settings.video.row.requireImage": "Gerar a partir de foto",
  "settings.video.row.requireImage.description":
    "Os vídeos animam uma foto que você anexa no chat (imagem → vídeo). Só aparecem modelos que aceitam imagem.",
  "settings.video.aspect.fromPhoto": "Segue a foto",
  "settings.video.advanced.hint": 'Opções que este modelo aceita por geração. Peça no chat, por exemplo "use seed 42".',
  "settings.video.advanced.none": "Este modelo não tem opções avançadas.",
  "settings.video.advanced.free": "Qualquer valor",
  "settings.video.advanced.seed": "Semente",
  "settings.video.advanced.inferenceSteps": "Etapas de inferência",
  "settings.video.advanced.numFrames": "Número de quadros",
  "settings.video.advanced.negativePrompt": "O que evitar",
  "settings.video.advanced.cameraFixed": "Câmera fixa",
  "settings.video.advanced.cfg": "Escala CFG",
  "settings.video.advanced.proMode": "Modo pro",
  "settings.video.saving": "Salvando…",
  "settings.video.saved": "Salvo",
  "settings.video.saveError": "Não foi possível salvar as configurações de vídeo.",
  "settings.video.purpose.hero": "Destaque",
  "settings.video.purpose.background": "Fundo",
  "settings.video.purpose.scroll": "Rolagem",
  "settings.video.purpose.product": "Produto",
  "settings.video.purpose.abstract": "Abstrato",
  "settings.video.purpose.section": "Seção",
  "settings.video.quality.draft": "Rascunho",
  "settings.video.quality.standard": "Padrão",
  "settings.video.quality.high": "Alta",
  "settings.video.motion.subtle": "Sutil",
  "settings.video.motion.medium": "Médio",
  "settings.video.motion.dynamic": "Dinâmico",
  "settings.video.camera.static": "Estática",
  "settings.video.camera.slow-pan": "Pan lento",
  "settings.video.camera.slow-zoom": "Zoom lento",
  "settings.video.camera.orbit": "Órbita",
  "settings.video.camera.dolly": "Aproximação",
  "settings.video.camera.custom": "Personalizada (pela descrição)",
  ...
  "settings.permissions.tool.glob.title": "Procurar arquivos",
  "settings.permissions.tool.glob.description": "Corresponder arquivos usando padrões glob",
  "settings.permissions.tool.grep.title": "Procurar no texto",
  ...
  "settings.permissions.tool.bash.title": "Terminal",
  "settings.permissions.tool.bash.description": "Executar comandos no terminal",
  ...
  "workspace.status.error": "Não foi possível verificar o estado do git.",
  ...
  "workspace.reset.note": "Isso redefinirá o espaço de trabalho para corresponder ao ramo padrão.",
  "common.open": "Abrir",
