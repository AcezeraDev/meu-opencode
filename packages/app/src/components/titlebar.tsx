...
import { PersonalUpdateButton } from "./personal-update-button"
...
export function Titlebar(props: { update?: TitlebarUpdate; debugTools?: { visible: boolean; toggle: () => void } }) {
  ...
  const updateState = createMemo<TitlebarUpdatePillState>(() => {
    ...
    return {
      // Personal builds have their own always-visible button (PersonalUpdateButton).
      visible: !platform.updater?.personal && (version !== undefined || installing),
      installing,
