...
export const SettingsProvidersV2: Component<{
  ...
  return (
    <>
      <div class="settings-v2-tab-header settings-v2-providers-header">
        <h2 class="settings-v2-tab-title">{language.t("settings.providers.title")}</h2>
        <button type="button" class="settings-v2-providers-search" onClick={() => connect()}>
          <Icon name="magnifying-glass" />
          <span>{language.t("dialog.provider.search.placeholder")}</span>
        </button>
      </div>
      ...
      <div class="settings-v2-tab-body settings-v2-providers">
        ...
        <div class="settings-v2-section">
          ...
          <div class="settings-v2-provider-grid" data-variant="popular">
            <For each={popular()}>
              {(item) => (
                <div class="settings-v2-provider-card" data-variant="popular">
                  <div class="settings-v2-provider-lead">
                    <span class="settings-v2-provider-tile">
                      <ProviderIcon
                        id={item.id}
          ...
          <Show when={protocol() === "v1"}>
            <div class="settings-v2-provider-custom" data-component="custom-provider-section">
              <div class="settings-v2-provider-lead">
                <span class="settings-v2-provider-tile">
                  <ProviderIcon
                    id="synthetic"
