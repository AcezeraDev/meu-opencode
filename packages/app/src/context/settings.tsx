...
export interface Settings {
  ...
  appearance: {
    ...
    sans: string
    terminal: string
    /** RGB accent that keeps cycling through hues (the scope trace color). */
    chroma?: boolean
...
export type ChromaSpeed = "slow" | "medium" | "fast"
  ...
  init: () => {
    ...
    return {
      ...
      appearance: {
        ...
        chroma: withFallback(() => store.appearance?.chroma, true),
        setChroma(value: boolean) {
          setStore("appearance", "chroma", value)
        },
        chromaSpeed: withFallback(() => store.appearance?.chromaSpeed, "medium" as ChromaSpeed),
        setChromaSpeed(value: ChromaSpeed) {
          setStore("appearance", "chromaSpeed", value)
        },
      ...
      usage: {
        dailyLimit: withFallback(() => store.usage?.dailyLimit, 0),
        setDailyLimit(value: number) {
          setStore("usage", { dailyLimit: Number.isFinite(value) && value > 0 ? value : 0 })
        },
      },
      keybinds: {
